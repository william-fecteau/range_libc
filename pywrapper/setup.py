...
compiler_flags = ["-w","-std=c++11", "-Xcompiler", "-march=native", "-Xcompiler", "-ffast-math", "-Xcompiler", "-fno-math-errno", "-Xcompiler", "-fPIC", "-O3"]
nvcc_flags = ['-arch=sm_89', '--ptxas-options=-v', '-c', '--compiler-options', "'-fPIC'", "-w","-std=c++11"]
